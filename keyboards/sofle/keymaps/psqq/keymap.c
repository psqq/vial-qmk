...
//--- begin of auto align
  ...
  KC_PSCR,  _______,     _______,  _______,  _______,  _______,                      _______,     KC_P7,          KC_P8,          KC_P9,          _______,   KC_SCRL,
  KC_CAPS,  KC_PSLS,     KC_PAST,  KC_PMNS,  KC_PPLS,  KC_PEQL,                      _______,     KC_P4,          KC_P5,          KC_P6,          KC_P0,     KC_NUM,
  KC_INS,   _______,     _______,  _______,  _______,  _______,  _______,  _______,  _______,     KC_P1,          KC_P2,          KC_P3,          _______,   KC_PAUSE,
                         _______,  _______,  _______,  _______,  _______,  _______,  _______,     _______,        _______,        _______
//--- end of auto align
),
[_UPPER] = LAYOUT(
//--- begin of auto align
  _______,  _______,     _______,  _______,  MS_WHLL,  MS_WHLR,                      KC_STOGGLE,  KC_PDF_0,       KC_PDF_L,       KC_PDF_U,       KC_PDF_A,  _______,
  _______,  C(KC_BSPC),  MS_BTN3,  MS_BTN2,  MS_BTN1,  MS_WHLU,                      KC_PGUP,     KC_PRVWD,       KC_SUP,         KC_NXTWD,       KC_HOME,   _______,
  _______,  KC_DEL,      KC_BSPC,  KC_ENT,   KC_SPC,   MS_WHLD,                      KC_PGDN,     KC_SLEFT,       KC_SDOWN,       KC_SRIGHT,      KC_END,    OSM(MOD_LGUI),
  _______,  C(KC_Z),     C(KC_X),  C(KC_C),  C(KC_V),  _______,  _______,  _______,  _______,     OSM(MOD_LSFT),  OSM(MOD_LCTL),  OSM(MOD_LALT),  _______,   _______,
                         _______,  _______,  _______,  _______,  _______,  _______,  _______,     _______,        _______,        _______
//--- end of auto align
),
  [_ADJUST] = LAYOUT(
